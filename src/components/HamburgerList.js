    ...
    <>
      ...
      <Offcanvas show={show} onHide={handleClose} backdrop={true} scroll={true} style={{ width: '60%', maxWidth: '300px' }}>
        ...
        <Offcanvas.Body id='hambergur-menu' className='d-flex flex-column'>
          ...
          <ListGroup variant='flush fs-5 mb-4'>
            ...
            <ListGroup.Item className='py-2'>
              <Link to="/qr-orders">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-qr-code me-3" viewBox="0 0 16 16">
                    <path d="M2 2h2v2H2z" />
            ...
            {role === 'ROLE_ADMIN' && <>
              ...
              <ListGroup.Item className='mt-4 py-2'>
                <Link to="/members">
                  <div>
